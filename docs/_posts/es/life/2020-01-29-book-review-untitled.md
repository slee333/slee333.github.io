...
title: "[Reseña del libro] Atención Sanitaria Digital: El Futuro de la Medicina"
...
### **<ins>¡Recomendado para las siguientes personas!</ins>**
...
En la segunda etapa, **integración de datos**, se discute cómo recolectar datos de diversas maneras en un solo lugar. A través de ejemplos como Apple Health Record o Validic, presentados en [publicaciones anteriores](https://brunch.co.kr/@gazezaet/13), el libro introduce primero el concepto de una plataforma de datos de salud que puede integrar varios tipos de datos.
...
Por supuesto, tampoco falta la mención de inteligencia artificial, la compañera inseparable del análisis de datos. Aunque el rol de la inteligencia artificial en la salud digital está bien abordado en el trabajo anterior del autor [‘Medicina e inteligencia artificial'](http://www.yes24.com/Product/Goods/61939431), interesantes ejemplos como IBM Watson y el diagnóstico de arritmias a través de un teléfono inteligente también se incluyen en este libro.
...
De hecho, anteriormente estuve involucrado en un proyecto llamado [EpiWatch](https://www.hopkinsmedicine.org/epiwatch/index.html), una aplicación que detecta y alerta ataques de epilepsia mediante Apple Watch y usé el wearable de salud Fitbit durante aproximadamente un año.
