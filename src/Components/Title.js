...
export default () => {
  return (
    <Box width="80%" style={{ paddingTop: "100px" }} bgColor={"#fff"} id="title">
      <SubBox basis={20} />
      <SubBox
        basis={80}
      ...
      >
        <div style={{width:"60%"}} >
          ...
          <ScrollAnimation style={{paddingLeft:"100px"}} delay={500} animateOnce={true} animateIn={"fadeIn"}>
            <Text fontSize={"50px"}>엔지니어 </Text>
          </ScrollAnimation>
          <ScrollAnimation style={{paddingLeft:"200px"}} delay={1000} animateOnce={true} animateIn={"fadeIn"}>
        ...
        <ScrollAnimation style={{width:"50%"}} delay={3000} animateIn={"fadeIn"} animateOnce={true}>
		...
		<Link smooth to="/#intro">
          <Text fontSize="30px" style={{ height: "10vh" }}>
            더 궁금하신가요? ↓
          </Text> </Link>
        </ScrollAnimation>
      </SubBox>
